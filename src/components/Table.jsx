...
import { useState } from 'react'; // Import useState for pagination state management
...
const Table = ({ datas, onSort, onDelete, onEdit, itemsPerPage = 10 }) => {
    ...
    return (
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg py-3">
                    ...
                    {currentData.map((data) => (
                        <tr key={data.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td className="px-6 py-4 flex flex-wrap gap-3">
                                <button onClick={() => onEdit(data)} className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</button>
                                <button onClick={() => onDelete(data.id)} className="font-medium text-red-600 dark:text-red-500 hover:underline">Delete</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
            ...
            <div className="flex justify-center mt-4">
                <button
                    className="px-4 py-2 mx-2 text-white bg-blue-600 rounded-lg disabled:bg-blue-400" 
